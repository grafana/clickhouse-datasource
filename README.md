...
| _$\_\_timeFilterInt64Ms(columnName)_           | Replaced by a conditional that filters Int64 columns storing millisecond epoch timestamps. Generates raw integer comparisons for optimal index usage.                               | `time >= 1415792726123 AND time <= 1447328726456`                                                     |
