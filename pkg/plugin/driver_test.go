...
func TestMergeOpenTelemetryLabels_Merge(t *testing.T) {
...
func TestMergeOpenTelemetryLabels_LabelsFieldPresent(t *testing.T) {
	frame := &data.Frame{
		Fields: []*data.Field{
...
func TestMergeOpenTelemetryLabels_EmptyFields(t *testing.T) {
	frame := &data.Frame{
		Fields: []*data.Field{},
	}
	err := mergeOpenTelemetryLabels(frame)
...
func TestMergeOpenTelemetryLabels_FieldTypeFilter(t *testing.T) {
